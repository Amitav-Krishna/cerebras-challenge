...
exports.activateDemoModeFast = activateDemoModeFast;
exports.deactivateDemoModeFast = deactivateDemoModeFast;
...
function activateDemoModeFast(context) {
    context.subscriptions.push(vscode.commands.registerCommand('cerebrasHud.startDemoFast', startDemo), vscode.commands.registerCommand('cerebrasHud.stopDemo', stopDemo));
}
...
function deactivateDemoModeFast() {
    stopDemo();
}
